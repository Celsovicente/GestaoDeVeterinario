...
public class EliminarSaida extends JFrame
{
    private PainelCentro centro;
    private PainelSul sul;
    
    public EliminarSaida()
    {
        super("Pesquisas da Saida para Eliminar");
            ...
            {    
                ...
                if(centro.getTipoPesquisa() == 1)
                {
                    ...
                    if(opcao == JOptionPane.YES_OPTION)
                    {
                        ...
                        new SaidaFile().eliminarDados(modelo);
                        dispose();
                    }
                    else    
