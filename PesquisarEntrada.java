...
Numero: 31179
Ficheiro: PesquisarEntrada.java
Data: 12.07.2025
--------------------------------------*/
import javax.swing.*;
...
public class PesquisarEntrada extends JFrame
{
    private PainelCentro centro;
    private PainelSul sul;
    
    public PesquisarEntrada()
    {
        super("Pesquisas da Entrada");
        ...
        public void actionPerformed(ActionEvent event)
        {
            ...
            {    
                if(centro.getTipoPesquisa() == 1)
                    EntradaFile.pesquisarPorData(centro.getDataProcurada());
                else if(centro.getTipoPesquisa() == 2)
                    EntradaFile.pesquisarPorNome(centro.getNomeProcurado());
            }
            else 
                dispose();
        }
