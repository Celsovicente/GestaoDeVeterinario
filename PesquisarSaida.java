...
public class PesquisarSaida extends JFrame
{
    private PainelCentro centro;
    private PainelSul sul;
    
    public PesquisarSaida()
    {
        super("Pesquisas da Saida");
        ...
        public void actionPerformed(ActionEvent event)
        {
            ...
            {    
                if(centro.getTipoPesquisa() == 1)
                    SaidaFile.pesquisarPorDataObeservacao(centro.getDataProcurada());
                else if(centro.getTipoPesquisa() == 2)
                    SaidaFile.pesquisarPorObservacao(centro.getObservacaoProcurado());
            }
            else 
                dispose();
        }
