...
public class PesquisarAnimal extends JFrame
{
        ...
        public void actionPerformed(ActionEvent event)
        {
            ...
            {    
                if(centro.getTipoPesquisa() == 1)
                    AnimalFile.pesquisarPorId(centro.getIdProcurado());
                else if(centro.getTipoPesquisa() == 2)
                    AnimalFile.pesquisarPorNome(centro.getNomeProcurado());
            }
            else 
                dispose();
        }
